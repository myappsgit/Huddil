...
public class UserPref implements java.io.Serializable {
	...
	public UserPref(int userId, String sessionId, String emailId, String mobileNo,
			String displayName, boolean mobileNoVerified) {
		this.userId = userId;
	...
	public UserPref(int userId, String city, Integer userType, String sessionId, String emailId,
			String mobileNo, String displayName, String comments, String blockedFacilities, boolean mobileNoVerified,
